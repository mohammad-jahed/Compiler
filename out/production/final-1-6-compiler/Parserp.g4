 ...
 FOR_OPENC bodyfor FOR_CLOSE
  ...
  ;
   forp:
    ...
    ;
bodyfor:
bodyforfirstvar BDYFOR bodyforsecondvar
// VARF FORNA  BDYFOR VARF FORNA
;
bodyforfirstvar:VARF FORNA;
bodyforsecondvar:VARF FORNA;
...
valid:REQUIREDV|STRINGV|EMAILV|(MINV NUM)|(MAXV NUM);
valid1:REQUIREDV|STRINGV|EMAILV|(MINV NUM)|(MAXV NUM);
...
validation:VALIDATION OPENC REQUEST CLOSEC OPENBRACKET (STRINGARR VALID ((valid(OR valid1)*)) CLOSE )* CLOSEBRACKET;
...
/*
 ...
 page p1{in:field(value)->val(id,name);}
